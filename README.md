...
- **EDA → feature engineering → baseline → Optuna tuning (CV + SMOTE) → evaluation**
...
│
├── outputs/
│   ├── figures/                 # committed (PNG plots used in README / review)
│   ├── *.csv                    # committed (metrics, thresholds, trials)
